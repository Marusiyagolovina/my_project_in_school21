...
class Tags:
    ...
    def most_words_and_longest(self, n):
        ...
        return sorted(intersected, key=lambda tag: (-len(tag.split()), -len(tag)))
...
10,GoldenEye (1995),Action|Adventure|Thriller"""
        ...
        with open(Tests.TEST_MOVIES_FILE, "w") as f:
            f.write(content)

    @staticmethod
    def create_test_ratings_file():
...
1,151,5.0,964984041
1,157,5.0,964984100"""
        with open(Tests.TEST_RATINGS_FILE, "w") as f:
            f.write(content)
...
9,0114576,9091
10,0113189,710"""
        with open(Tests.TEST_LINKS_FILE, "w") as f:
            f.write(content)
...
15,1951,dentist,1193435061
15,2918,alternate ending,1178944910
15,3265,mental illness,1173213683
15,3361,ambiguous ending,1179038347
15,3745,dark comedy,1193377924
15,3916,character study,1178989995
15,4082,thought-provoking,1178990287
15,4344,visually appealing,1173213670
15,4404,alcohol,1178990152"""
        with open(Tests.TEST_TAGS_FILE, "w") as f:
            f.write(content)

    @pytest.fixture(scope="module", autouse=True)
    def setup_test_files(self):
        self.create_test_movies_file()
        self.create_test_ratings_file()
        self.create_test_links_file()
        self.create_test_tags_file()
    ...
    class TestLinksClass:
        ...
        def links_obj(self):
            return Links(Tests.TEST_LINKS_FILE)
